...
public class HttpsWebRequest extends WebRequest{
	public HttpsWebRequest(Browser browser,URL url,String method,boolean report){super(browser,url,method,report);}
	@Override public void run(){
		...
		try{
			...
			responseHeaderFields=c.getHeaderFields();
			// parse cookies
