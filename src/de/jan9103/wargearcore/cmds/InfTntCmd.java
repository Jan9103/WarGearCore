...
public class InfTntCmd extends UserOnlyCmd {
	@Override public void exe(String[] a,User u,Player p){
		if(BlockPlaceListener.infTnt.remove(p))
			new Msg(u).a("Deactivated Inf-Tnt.").a(p);
		else{
			BlockPlaceListener.infTnt.add(p);
			new Msg(u).a("Activated Inf-Tnt.").a(p);
		}
	}
}
