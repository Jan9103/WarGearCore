...
public class LoreCommand extends UserOnlyCmd {
	@Override public void exe(final String[] args,User u,Player p){
		...
		if(item==null||item.getType()==Material.AIR){
			new Msg(u).b("Please select a valid Item in your Inventory"); return;
		}
		final ItemMeta meta=item.getItemMeta();

		meta.setLore(Arrays.asList(String.join(" ",args).replace("$$","\n").replace('$','§').replace("\n","$").split("\\n")));
