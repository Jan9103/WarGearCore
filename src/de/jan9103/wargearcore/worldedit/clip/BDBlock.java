...
public class BDBlock extends ClipboardBlock {
	private static final long serialVersionUID=4338052569191514389L;
	public final byte b;
	public BDBlock(byte di){
		b=di;
	}

	public BDBlock(int di){
		b=(byte)di;
	}
	...
	@Override public boolean compare(ClipboardBlock b){
		if(!(b instanceof BDBlock)) return false; return ((BDBlock)b).b==this.b;
	}
}
