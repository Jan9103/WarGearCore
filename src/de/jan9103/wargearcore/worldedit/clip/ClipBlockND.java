...
public class ClipBlockND extends ClipboardBlock {
	private static final long serialVersionUID=5492164956516420144L;
	private final Material m;
	public ClipBlockND(Material mat){
		m=mat;
	}
	...
	@Override public ClipboardBlock copy(){
		return new ClipBlockND(m);
	}

	@Override public boolean compare(ClipboardBlock b){
		return b.getD()==null&&b.getM()==m;
	}
}
