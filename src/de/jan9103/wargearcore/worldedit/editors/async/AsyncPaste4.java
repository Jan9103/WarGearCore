 ...
 * ONLY CALL ASYNC !!
 */
public class AsyncPaste4 extends AsyncEditor3 {
	private final CraftWorld cw;
	private final CBv2 c2;
	private Clipboard c;
	private final boolean o;
	private final ATheme.THM at;
	public AsyncPaste4(World world,BigCoord pos,WeSender source,CBv2 cb,boolean or){
		super(world,pos.toAr(1,1,1),false,source); o=or; cw=(CraftWorld)world; c2=cb; at=ATheme.THM.GRAY;
	}

	public AsyncPaste4(World world,BigCoord pos,WeSender source,CBv2 cb,boolean or,ATheme.THM thm){
		super(world,pos.toAr(1,1,1),false,source); o=or; cw=(CraftWorld)world; c2=cb; at=thm;
	}
	...
	@Override public void prepUndo(Undo i){
		...
		if(o){
			xl=c.originalCopyPoint.x+c.cv.x;
			yl=c.originalCopyPoint.y+c.cv.y;
			zl=c.originalCopyPoint.z+c.cv.z;
		}
		else{
			xl=this.xl+c.cv.x;
			yl=this.yl+c.cv.y;
