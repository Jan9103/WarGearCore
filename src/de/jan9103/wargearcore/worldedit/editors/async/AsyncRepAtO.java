...
public class AsyncRepAtO extends AsyncEditor3 {
	public final Material to;
	public final Material[] from;
	private final CraftWorld cw;
	public AsyncRepAtO(World world,BigArea area,Material[] f,Material t,boolean u,WeSender s){
		super(world,area,u,s); cw=(CraftWorld)w; from=f; to=t;
	}
