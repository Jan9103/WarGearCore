...
public class AsyncSetOD extends AsyncEditor3 {
	public final BlockData to;
	private final CraftWorld cw;
	public AsyncSetOD(World world,BigArea area,BlockData t,boolean u,WeSender s){
		super(world,area,u,s); to=t; cw=(CraftWorld)w;
	}
