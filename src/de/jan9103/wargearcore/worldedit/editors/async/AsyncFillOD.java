 ...
 */
public class AsyncFillOD extends AsyncEditor3 {
	public final BlockData to;
	public AsyncFillOD(World world,BigArea area,BlockData t,boolean u,WeSender s){
		super(world,area,u,s); to=t;
	}
		...
		for(int x=xl; x<=xh; x++)
			for(int y=yl; y<=yh; y++)
				for(int z=zl; z<=zh; z++){
					...
					if(b.getType()==Material.AIR) b.setBlockData(to,u);
				}
	}
