 ...
 */
public class AsyncFillO extends AsyncEditor3 {
	public final Material to;
	public AsyncFillO(World world,BigArea area,Material t,boolean u,WeSender s){
		...
		for(int x=xl; x<=xh; x++)
			for(int y=yl; y<=yh; y++)
				for(int z=zl; z<=zh; z++){
					...
					if(b.getType()==Material.AIR) b.setType(to,u);
				}
	}
