...
public class AsyncSetA extends AsyncEditor3 {
	public final Material[] to;
	public final Random r;
	private final CraftWorld cw;
	public AsyncSetA(World world,BigArea area,Material[] t,boolean u,WeSender s){
		super(world,area,u,s); cw=(CraftWorld)w; to=t; r=new Random();
	}
