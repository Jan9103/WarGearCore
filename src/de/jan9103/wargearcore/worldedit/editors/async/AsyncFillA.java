 ...
 */
public class AsyncFillA extends AsyncEditor3 {
	public final Material[] to;
	public final Random r;
	public AsyncFillA(World world,BigArea area,Material[] t,boolean u,WeSender s){
		super(world,area,u,s); to=t; r=new Random();
	}
		...
		for(int x=xl; x<=xh; x++)
			for(int y=yl; y<=yh; y++)
				for(int z=zl; z<=zh; z++){
					...
					if(b.getType()==Material.AIR) b.setType(to[r.nextInt(to.length)],u);
				}
	}
