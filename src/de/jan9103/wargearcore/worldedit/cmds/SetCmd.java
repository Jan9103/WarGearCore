...
public class SetCmd extends PlaceCommand {
	@Override public void execu(WEArea a,String[] args,User u,Player p){
		...
		if(to.length==1) aso=new AsyncSetO(a.w,a.toBigArea(),to[0],upd,u);
		else aso=new AsyncSetA(a.w,a.toBigArea(),to,upd,u);

		if(u.saveUndo) u.saveUndo(aso.getUndo(),"set-"+to[0].toString());
		aso.aFromSync();
	}
}
