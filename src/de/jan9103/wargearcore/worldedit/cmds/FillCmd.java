...
public class FillCmd extends PlaceCommand {
	@Override public void execu(WEArea a,String[] args,User u,Player p){
		...
		StackWeAction d=to.length==1?new AsyncFillO(a.w,a.toBigArea(),to[0],upd,u):new AsyncFillA(a.w,a.toBigArea(),to,upd,u);

		if(u.saveUndo) u.saveUndo(d.getUndo(),"fill-"+to[0].toString());
		d.aFromSync();
	}
}
