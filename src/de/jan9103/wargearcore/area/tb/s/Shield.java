...
public abstract class Shield {
	public void a(WgArea a,WeSender s){
		AsyncMultiEditor ame=new AsyncMultiEditor(s); aLater(ame,a); ame.exe();
	}

	public abstract void b(WgArea a,WeSender s);
	public abstract void aLater(AsyncMultiEditor ame,WgArea a);
