...
public class WallS extends Shield {
	@Override public void b(WgArea a,WeSender s){
	}

	@Override public void aLater(AsyncMultiEditor ame,WgArea a){
		WallCreator.add(ame,a.w,new BigArea(new BigCoord(a.redWg.low.x-a.ausfahrm,a.redWg.low.y,a.redWg.low.z-a.ausfm_front),new BigCoord(a.redWg.high.x+a.ausfahrm,a.redWg.high.y,a.redWg.high.z+a.ausfahrm)),ATheme.get(a.thm,ThemeMat.OWN_THIN_SHIELD,true),false);
	}
