...
public class FreezeCmd extends UserOnlyCmd {
	@Override public void exe(String[] a,User u,Player p){
		final WgArea b=WgArea.inside(u.getPlayer().getLocation());

		if(b==null){
			new Msg(u,WGC._PREFIX_2_Area).b("You need to be in an area.").a(p);
			return;
		}
