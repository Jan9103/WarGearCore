...
public class ExplosionListener implements Listener {
	public static final HashSet<String>tntOn=new HashSet<>();
	@EventHandler public void a(EntityExplodeEvent e){
		try{
			final WgArea a=WgArea.inside(e.getLocation());
			if(a==null){
				if(!tntOn.contains(e.getLocation().getWorld().getName())) e.blockList().clear(); return;
			}
			a.handleExplosion(e);
